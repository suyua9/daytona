# daytona_toolbox_api_client_async.ComputerUseApi
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a recording
        await api_instance.delete_recording(id)
    except Exception as e:
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Download a recording
        api_response = await api_instance.download_recording(id)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client_async.ComputerUseApi(api_client)
    request = daytona_toolbox_api_client_async.MouseDragRequest() # MouseDragRequest | Mouse drag request

    try:
        # Drag mouse
        api_response = await api_instance.drag(request)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get computer use process status
        api_response = await api_instance.get_computer_use_status()
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get computer use status
        api_response = await api_instance.get_computer_use_system_status()
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get display information
        api_response = await api_instance.get_display_info()
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get mouse position
        api_response = await api_instance.get_mouse_position()
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get process errors
        api_response = await api_instance.get_process_errors(process_name)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get process logs
        api_response = await api_instance.get_process_logs(process_name)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get specific process status
        api_response = await api_instance.get_process_status(process_name)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get recording details
        api_response = await api_instance.get_recording(id)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get windows information
        api_response = await api_instance.get_windows()
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List all recordings
        api_response = await api_instance.list_recordings()
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client_async.ComputerUseApi(api_client)
    request = daytona_toolbox_api_client_async.MouseMoveRequest() # MouseMoveRequest | Mouse move request

    try:
        # Move mouse cursor
        api_response = await api_instance.move_mouse(request)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client_async.ComputerUseApi(api_client)
    request = daytona_toolbox_api_client_async.KeyboardHotkeyRequest() # KeyboardHotkeyRequest | Hotkey press request

    try:
        # Press hotkey
        api_response = await api_instance.press_hotkey(request)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client_async.ComputerUseApi(api_client)
    request = daytona_toolbox_api_client_async.KeyboardPressRequest() # KeyboardPressRequest | Key press request

    try:
        # Press key
        api_response = await api_instance.press_key(request)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Restart specific process
        api_response = await api_instance.restart_process(process_name)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client_async.ComputerUseApi(api_client)
    request = daytona_toolbox_api_client_async.MouseScrollRequest() # MouseScrollRequest | Mouse scroll request

    try:
        # Scroll mouse wheel
        api_response = await api_instance.scroll(request)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Start computer use processes
        api_response = await api_instance.start_computer_use()
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client_async.ComputerUseApi(api_client)
    request = daytona_toolbox_api_client_async.StartRecordingRequest() # StartRecordingRequest | Recording options (optional)

    try:
        # Start a new recording
        api_response = await api_instance.start_recording(request=request)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Stop computer use processes
        api_response = await api_instance.stop_computer_use()
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client_async.ComputerUseApi(api_client)
    request = daytona_toolbox_api_client_async.StopRecordingRequest() # StopRecordingRequest | Recording ID to stop

    try:
        # Stop a recording
        api_response = await api_instance.stop_recording(request)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Take a compressed region screenshot
        api_response = await api_instance.take_compressed_region_screenshot(x, y, width, height, show_cursor=show_cursor, format=format, quality=quality, scale=scale)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Take a compressed screenshot
        api_response = await api_instance.take_compressed_screenshot(show_cursor=show_cursor, format=format, quality=quality, scale=scale)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Take a region screenshot
        api_response = await api_instance.take_region_screenshot(x, y, width, height, show_cursor=show_cursor)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Take a screenshot
        api_response = await api_instance.take_screenshot(show_cursor=show_cursor)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client_async.ComputerUseApi(api_client)
    request = daytona_toolbox_api_client_async.KeyboardTypeRequest() # KeyboardTypeRequest | Text typing request

    try:
        # Type text
        api_response = await api_instance.type_text(request)

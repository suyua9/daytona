# daytona_toolbox_api_client_async.ProcessApi
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    api_instance = daytona_toolbox_api_client_async.ProcessApi(api_client)
    request = daytona_toolbox_api_client_async.CodeRunRequest() # CodeRunRequest | Code execution request

    try:
        # Execute code
        api_response = await api_instance.code_run(request)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Connect to PTY session via WebSocket
        await api_instance.connect_pty_session(session_id)
    except Exception as e:
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client_async.ProcessApi(api_client)
    request = daytona_toolbox_api_client_async.PtyCreateRequest() # PtyCreateRequest | PTY session creation request

    try:
        # Create a new PTY session
        api_response = await api_instance.create_pty_session(request)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client_async.ProcessApi(api_client)
    request = daytona_toolbox_api_client_async.CreateSessionRequest() # CreateSessionRequest | Session creation request

    try:
        # Create a new session
        await api_instance.create_session(request)
    except Exception as e:
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a PTY session
        api_response = await api_instance.delete_pty_session(session_id)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a session
        await api_instance.delete_session(session_id)
    except Exception as e:
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client_async.ProcessApi(api_client)
    request = daytona_toolbox_api_client_async.ExecuteRequest() # ExecuteRequest | Command execution request

    try:
        # Execute a command
        api_response = await api_instance.execute_command(request)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get entrypoint logs
        api_response = await api_instance.get_entrypoint_logs(follow=follow)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get entrypoint session details
        api_response = await api_instance.get_entrypoint_session()
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get PTY session information
        api_response = await api_instance.get_pty_session(session_id)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get session command details
        api_response = await api_instance.get_session_command(session_id, command_id)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get session command logs
        api_response = await api_instance.get_session_command_logs(session_id, command_id, follow=follow)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List all PTY sessions
        api_response = await api_instance.list_pty_sessions()
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List all sessions
        api_response = await api_instance.list_sessions()
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    api_instance = daytona_toolbox_api_client_async.ProcessApi(api_client)
    session_id = 'session_id_example' # str | PTY session ID
    request = daytona_toolbox_api_client_async.PtyResizeRequest() # PtyResizeRequest | Resize request with new dimensions

    try:
        # Resize a PTY session
        api_response = await api_instance.resize_pty_session(session_id, request)
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    session_id = 'session_id_example' # str | Session ID
    command_id = 'command_id_example' # str | Command ID
    request = daytona_toolbox_api_client_async.SessionSendInputRequest() # SessionSendInputRequest | Input send request

    try:
        # Send input to command
        await api_instance.send_input(session_id, command_id, request)
    except Exception as e:
...
async with daytona_toolbox_api_client_async.ApiClient(configuration) as api_client:
    ...
    api_instance = daytona_toolbox_api_client_async.ProcessApi(api_client)
    session_id = 'session_id_example' # str | Session ID
    request = daytona_toolbox_api_client_async.SessionExecuteRequest() # SessionExecuteRequest | Command execution request

    try:
        # Execute command in session
        api_response = await api_instance.session_execute_command(session_id, request)

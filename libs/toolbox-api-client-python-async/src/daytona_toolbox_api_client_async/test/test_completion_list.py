    ...
    def make_instance(self, include_optional) -> CompletionList:
        ...
        if include_optional:
            return CompletionList(
                is_incomplete = True,
                items = [
                    daytona_toolbox_api_client_async.models.completion_item.CompletionItem(
                        detail = '', 
                        documentation = daytona_toolbox_api_client_async.models.documentation.documentation(), 
                        filter_text = '', 
                        insert_text = '', 
                        kind = 56, 
                        label = '', 

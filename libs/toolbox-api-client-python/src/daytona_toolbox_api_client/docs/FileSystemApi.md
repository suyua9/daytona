# daytona_toolbox_api_client.FileSystemApi
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = daytona_toolbox_api_client.FileSystemApi(api_client)
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a file or directory
        api_instance.delete_file(path, recursive=recursive)
    except Exception as e:
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client.FileSystemApi(api_client)
    download_files = daytona_toolbox_api_client.FilesDownloadRequest() # FilesDownloadRequest | Paths of files to download

    try:
        # Download multiple files
        api_response = api_instance.download_files(download_files)
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Find text in files
        api_response = api_instance.find_in_files(path, pattern)
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get file information
        api_response = api_instance.get_file_info(path)
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client.FileSystemApi(api_client)
    request = daytona_toolbox_api_client.ReplaceRequest() # ReplaceRequest | Replace request

    try:
        # Replace text in files
        api_response = api_instance.replace_in_files(request)
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Search files by pattern
        api_response = api_instance.search_files(path, pattern)
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Set file permissions
        api_instance.set_file_permissions(path, owner=owner, group=group, mode=mode)
    except Exception as e:
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Upload a file
        api_response = api_instance.upload_file(path, file)

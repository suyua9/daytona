# daytona_toolbox_api_client.GitApi
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = daytona_toolbox_api_client.GitApi(api_client)
    request = daytona_toolbox_api_client.GitAddRequest() # GitAddRequest | Add files request
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client.GitApi(api_client)
    request = daytona_toolbox_api_client.GitCheckoutRequest() # GitCheckoutRequest | Checkout request
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client.GitApi(api_client)
    request = daytona_toolbox_api_client.GitCloneRequest() # GitCloneRequest | Clone repository request
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client.GitApi(api_client)
    request = daytona_toolbox_api_client.GitCommitRequest() # GitCommitRequest | Commit request

    try:
        # Commit changes
        api_response = api_instance.commit_changes(request)
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client.GitApi(api_client)
    request = daytona_toolbox_api_client.GitBranchRequest() # GitBranchRequest | Create branch request
...
```python
import daytona_toolbox_api_client
from daytona_toolbox_api_client.models.pkg_toolbox_git_git_delete_branch_request import PkgToolboxGitGitDeleteBranchRequest
from daytona_toolbox_api_client.rest import ApiException
from pprint import pprint
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client.GitApi(api_client)
    request = daytona_toolbox_api_client.PkgToolboxGitGitDeleteBranchRequest() # PkgToolboxGitGitDeleteBranchRequest | Delete branch request
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get commit history
        api_response = api_instance.get_commit_history(path)
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Git status
        api_response = api_instance.get_status(path)
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List branches
        api_response = api_instance.list_branches(path)
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client.GitApi(api_client)
    request = daytona_toolbox_api_client.GitRepoRequest() # GitRepoRequest | Pull request
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client.GitApi(api_client)
    request = daytona_toolbox_api_client.GitRepoRequest() # GitRepoRequest | Push request

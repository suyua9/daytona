# daytona_toolbox_api_client.InfoApi
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = daytona_toolbox_api_client.InfoApi(api_client)

    try:
        # Get user home directory
        api_response = api_instance.get_user_home_dir()
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get working directory
        api_response = api_instance.get_work_dir()

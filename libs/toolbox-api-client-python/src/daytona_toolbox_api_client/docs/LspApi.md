# daytona_toolbox_api_client.LspApi
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = daytona_toolbox_api_client.LspApi(api_client)
    request = daytona_toolbox_api_client.LspCompletionParams() # LspCompletionParams | Completion request

    try:
        # Get code completions
        api_response = api_instance.completions(request)
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client.LspApi(api_client)
    request = daytona_toolbox_api_client.LspDocumentRequest() # LspDocumentRequest | Document request
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get document symbols
        api_response = api_instance.document_symbols(language_id, path_to_project, uri)
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_toolbox_api_client.LspApi(api_client)
    request = daytona_toolbox_api_client.LspServerRequest() # LspServerRequest | LSP server request
...
with daytona_toolbox_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get workspace symbols
        api_response = api_instance.workspace_symbols(query, language_id, path_to_project)

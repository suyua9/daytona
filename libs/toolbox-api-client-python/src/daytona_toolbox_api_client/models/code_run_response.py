...
class CodeRunResponse(BaseModel):
    ...
    CodeRunResponse
    """ # noqa: E501
    artifacts: Optional[CodeRunArtifacts] = None
    exit_code: Optional[StrictInt] = Field(default=None, alias="exitCode")
    result: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["artifacts", "exitCode", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "artifacts": CodeRunArtifacts.from_dict(obj["artifacts"]) if obj.get("artifacts") is not None else None,
